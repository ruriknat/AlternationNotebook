...
//                                                tabelaOrdensRecurso.Add((recursoIDProgramado, ordem2.OrderNo, ordem2.Record, tempoFim)); // Substitua 'primeiraOrdem.Id' pelo campo correto que identifica a ordem
//                                                quantidadeRestanteRobo1Mesa1 = ListaOrdemSoldarRoboOrdenada.Count(r => r.OrderNo == ordem2.OrderNo && r.Programada == false);
//                                                tabelaOrdensRecurso.Remove(item); // Remove o item da tabela de ordens e recursos programados


//                                                //// Registra a ordem e o recurso na tabela
//                                                //foreach (var ordemSeq in ListaOrdemSoldarRoboOrdenada.Where(o => o.OrderNo == ordem2.OrderNo))
//                                                //{
//                                                //    tabelaOrdensRecurso.Add((recursoIDProgramado, ordemSeq.OrderNo, ordemSeq.Record, tempoFim)); // Substitua 'primeiraOrdem.Id' pelo campo correto que identifica a ordem
//                                                //    quantidadeRestanteRobo1Mesa1 = ListaOrdemSoldarRoboOrdenada.Count(r => r.OrderNo == ordemSeq.OrderNo && r.Programada == false);
