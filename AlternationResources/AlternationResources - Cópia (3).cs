...
//            // Agora ordena a lista final com base no novo valor de ordenação
...
//                    {
//                        int recursoSelecionado = testeop1.Value.ChangeStart <= testeop2.Value.ChangeStart ? recurso1 : recurso2;
...
//                    }
//                    else if (testeop2.HasValue && (RegistoOrdem.RecursoRequerido == -1 || RegistoOrdem.RecursoRequerido == recurso2))
//                    {
//                        preactor.PlanningBoard.PutOperationOnResource(RegistoOrdem.Record, recurso2, testeop2.Value.ChangeStart);
//                        RegistoOrdem.Programada = true;
//                        foreach (var ordem in ListaOrders.Where(o => o.OrderNo == RegistoOrdem.OrderNo))
//                        {
//                            ordem.RecursoRequerido = recurso2;
//                        }
//                        // Atualiza a data de fim
//                        DIMC = preactor.ReadFieldDateTime("Orders", "End Time", RegistoOrdem.Record);
//                    }
//                    else if (testeop1.HasValue && (RegistoOrdem.RecursoRequerido == -1 || RegistoOrdem.RecursoRequerido == recurso1))
//                    {
//                        preactor.PlanningBoard.PutOperationOnResource(RegistoOrdem.Record, recurso1, testeop1.Value.ChangeStart);
//                        RegistoOrdem.Programada = true;
//                        foreach (var ordem in ListaOrders.Where(o => o.OrderNo == RegistoOrdem.OrderNo))
//                        {
//                            ordem.RecursoRequerido = recurso1;
//                        }
//                        // Atualiza a data de fim
//                        DIMC = preactor.ReadFieldDateTime("Orders", "End Time", RegistoOrdem.Record);
//                    }
