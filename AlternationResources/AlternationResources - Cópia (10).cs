...
//                    var primeiraOrdem = listaOrdemSoldarRobo.First();
...
//                    // Itera sobre os recursos para realizar os testes
//                    foreach (var recursoId in listaInteracoesRecursos)
//                    {
//                        // Realiza o teste de operação para o recurso atual e a ordem
//                        var resultadoTeste = preactor.PlanningBoard.TestOperationOnResource(primeiraOrdem.Record, recursoId, dimc);

//                        if (resultadoTeste.HasValue)
//                        {
//                            // Armazena o recurso e o tempo de início do teste
//                            listaResultadosTestes.Add((recursoId, resultadoTeste.Value.ChangeStart));
//                        }
//                    }
...
//                            (string.IsNullOrEmpty(OrderNoRecurso1) || primeiraOrdem.OrderNo == OrderNoRecurso1) &&
//                            (string.IsNullOrEmpty(OrderNoRecurso2) || primeiraOrdem.OrderNo == OrderNoRecurso2))
//                        {
//                            // Realiza o "SequenceOperation" com o menor tempo de início (ChangeStart)
//                            preactor.PlanningBoard.SequenceOperation(primeiraOrdem.Record, SequenceOperationSelection.ThisOperation, resultadoMinimo.changeStart);

//                            // Marca a ordem como programada
//                            primeiraOrdem.Programada = true;

//                            // Atualiza as variáveis de controle de recursos
//                            if (OrderNoRecurso1 == string.Empty || primeiraOrdem.OrderNo == OrderNoRecurso1)
//                                OrderNoRecurso1 = primeiraOrdem.OrderNo;

//                            if (OrderNoRecurso2 == string.Empty || primeiraOrdem.OrderNo == OrderNoRecurso2)
//                                OrderNoRecurso2 = primeiraOrdem.OrderNo;
//                        }
//                    }
//                }
