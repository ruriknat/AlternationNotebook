...
//                                    queueOrdens.Where(x => x.OrderNo == OrderNoRecurso1).OrderBy(x => x.OrderNo);
//                                    CalendarState? calendarState = preactor.PlanningBoard.GetCurrentCalendarState(recursoSelecionado, dimc.AddSeconds(30)); // Atualiza o estado do calendário para o recurso
//                                    var teste = calendarState.Value.Efficiency;
//                                }
//                                else if (recursoSelecionado == listaRecursos[1])
//                                {
//                                    OrderNoRecurso2 = ordem.OrderNo;
//                                    queueOrdens.Where(x => x.OrderNo == OrderNoRecurso2).OrderBy(x => x.OrderNo);
//                                    CalendarState? calendarState = preactor.PlanningBoard.GetCurrentCalendarState(recursoSelecionado, dimc.AddSeconds(30)); // Atualiza o estado do calendário para o recurso
//                                    var teste = calendarState.Value.Efficiency;
//                                }
...
//                        }
//                        else if (string.IsNullOrEmpty(OrderNoRecurso1))
//                        {
//                            queueOrdens.OrderBy(x => x.OrdenacaoPeca).ThenBy(x => x.ValorOrdenacao);
//                        }
//                        else if (string.IsNullOrEmpty(OrderNoRecurso2))
//                        {
//                            queueOrdens.OrderBy(x => x.OrdenacaoPeca).ThenBy(x => x.ValorOrdenacao);
//                        }
...
//                            queueOrdens.Enqueue(RegistoOrdem);
//                        }
